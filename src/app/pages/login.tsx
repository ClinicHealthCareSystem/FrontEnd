...
export default function Login() {
  ...
  return (
    ...
    <TouchableOpacity style={styles.button} onPress={handleSubmit(handleSignIp)}>< Text style={styles.buttonText}> Login</Text></TouchableOpacity>
    
    <TouchableOpacity><Text style={styles.cadastro} onPress={() => router.navigate('/cadastro')}>Cadastre-se</Text></TouchableOpacity>
        </ScrollView>
  );
}
