...
<View style={styles.formInput}>
    ...
    <View style={{ flex: 1 }}>
        ...
        <Picker.Item label="Exame de Prostata" value="examedeprostata"/>
        </Picker>
    {error && (
    ...
    render={({
          field:{onChange,value},
            ...
            <Picker
                ...
                style={styles.formPicker}
                >
        <Picker.Item label="Selecione uma unidade para seu exame"value={null}/>
...
<TouchableOpacity
    ...
    <Text style={styles.scheduleButtonText}>Confirmar seu Agendamento</Text>
    </TouchableOpacity>
    </View>
    </ScrollView>
    <TabsNavegation/>
